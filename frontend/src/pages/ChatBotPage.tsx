...
const mockData: IChatData[] = [
  ...
  {
    sender: "user",
    message: "I want to learn basic Python, with course should I take?",
  },
  { sender: "bot", message: "You should take the course Python for beginners" },
  { sender: "user", message: "Thank you" },
];
      ...
      >
        ...
        >
          ...
          >
            ...
            <Button
              onClick={() => {
                setChatData([...chatData, { sender: "user", message }]);
                setMessage("");
              }}
            >
              <SendIcon />
